...
const addDepartmentModalVisible = ref(true);
...
const emit = defineEmits(['closeModal', 'departmentCreated']);
    ...
    try {
        axios.post(route('department.store'), {
            ...
            .then((response) => {
                ...
                closeModal();
                emit('departmentCreated', response.data.data);
            }).catch((error) => {
...
<template>
    ...
    <Dialog :open="addDepartmentModalVisible" @update:open="closeModal">
